import { getFileId, loadContent, isLocaleFile, warn } from '../src';
...
describe('utils tests: isLocaleFile', () => {
  test('01/valid patterns', async () => {
    ...
    expect(isLocaleFile(file1, patterns)).toBe(true);
    expect(isLocaleFile(file3, patterns)).toBe(true);
    expect(isLocaleFile(file4, patterns)).toBe(true);
    expect(isLocaleFile(file5, patterns)).toBe(true);
    expect(isLocaleFile(file6, patterns)).toBe(true);
    expect(isLocaleFile(file8, patterns)).toBe(true);
  });
  ...
  test('02/invalid patterns', async () => {
    ...
    expect(isLocaleFile(file2, patterns)).toBe(false);
    expect(isLocaleFile(file7, patterns)).toBe(false);
  });
  ...
  test('03/not exist', async () => {
    ...
    expect(isLocaleFile(file1, patterns)).toBe(false);
    expect(isLocaleFile(file2, patterns)).toBe(false);
    expect(isLocaleFile(file3, patterns)).toBe(false);
    expect(isLocaleFile(file4, patterns)).toBe(false);
    expect(isLocaleFile(file5, patterns)).toBe(false);
    expect(isLocaleFile(file6, patterns)).toBe(false);
  })
});
